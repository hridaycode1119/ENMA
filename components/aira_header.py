"""
AIRA Top Header Bar Component.
Renders greeting, search bar, notifications badge, voice trigger, and New Task launcher.
"""

from __future__ import annotations
import streamlit as st

def render_aira_header(on_new_task_click=None) -> None:
    """Renders the top header bar matching the AIRA design."""
    ...
    with col_greeting:
        st.markdown(
            """
            <div>
                <h1 class="aira-greeting-title">Good morning, Vaishnavi! 👋</h1>
                <div class="aira-greeting-sub">AIRA is ready to help you automate, organize and accelerate your work.</div>
            </div>
            """,
