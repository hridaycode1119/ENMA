"""
AIRA Master Enterprise Dashboard Component.
...
def render_aira_dashboard(orchestrator: AgentOrchestrator, on_navigate_view) -> None:
    """Renders the complete 12-widget unified AIRA AI Agent Dashboard."""
    ...
    with mid_left:
        st.markdown(
            """
            <div class="aira-card">
                <div class="aira-card-header">
                    <div class="aira-card-title">Recent Activity</div>
                    <span class="aira-card-link">View All</span>
                </div>
    ...
    with mid_center:
        st.markdown(
            ...
            <div class="aira-card">
                <div class="aira-card-header">
                    <div class="aira-card-title">🤖 AI Assistant</div>
                </div>
                <div class="ai-assistant-bubble">
                    <p><strong>Hi Vaishnavi! 👋</strong><br>How can I help you today?</p>
                </div>
            </div>
            """,
            unsafe_allow_html=True,
        ...
        with chip_col1:
            if st.button("📄 Summarize a document", key="aira_chip_sum", use_container_width=True):
                st.session_state["aira_active_view"] = "documents"
                st.rerun()
            if st.button("📊 Analyze data", key="aira_chip_data", use_container_width=True):
                st.session_state["aira_active_view"] = "documents"
                st.rerun()
        with chip_col2:
            if st.button("📅 Schedule a meeting", key="aira_chip_meet", use_container_width=True):
                st.session_state["aira_active_view"] = "calendar"
                st.rerun()
            if st.button("📝 Generate report", key="aira_chip_rep", use_container_width=True):
                st.session_state["aira_active_view"] = "documents"
                st.rerun()

        # Conversational Task Prompt Box
        with st.form(key="aira_prompt_form"):
            ...
            if submit_prompt and user_prompt.strip():
                with st.spinner("AIRA reasoning over instruction..."):
        ...
        with f_c3:
            if st.button("✅ Task Planner", key="feat_planner", use_container_width=True):
                st.session_state["aira_active_view"] = "tasks"
                st.rerun()
        with f_c4:
            if st.button("⚡ Workflow", key="feat_flow", use_container_width=True):
                st.session_state["aira_active_view"] = "terminal"
                st.rerun()
    ...
    with mid_right:
        st.markdown(
            ...
            <div class="aira-card">
                <div class="aira-card-header">
                    <div class="aira-card-title">Today's Schedule</div>
                    <span class="aira-card-link">View Calendar</span>
                </div>
    ...
    with low_col1:
        st.markdown(
            ...
            <div class="aira-card">
                <div class="aira-card-header">
                    <div class="aira-card-title">Task Overview</div>
                </div>
    ...
    with low_col2:
        st.markdown(
            ...
            <div class="aira-card">
                <div class="aira-card-header">
                    <div class="aira-card-title">File Manager</div>
                    <span class="aira-card-link">View All</span>
                </div>
                <div class="activity-item">
    ...
    with low_col3:
        st.markdown(
            ...
            <div class="aira-card">
                <div class="aira-card-header">
                    <div class="aira-card-title">Quick Tools</div>
                </div>
            </div>
            """,
            unsafe_allow_html=True,
    ...
    with low_col4:
        st.markdown(
            ...
            <div class="aira-card">
                <div class="aira-card-header">
                    <div class="aira-card-title">Voice Assistant</div>
                </div>
    ...
    with bot_col1:
        st.markdown(
            ...
            <div class="aira-card">
                <div class="aira-card-header">
                    <div class="aira-card-title">💻 Command Center</div>
                    <span class="aira-card-link">View All Commands</span>
                </div>
    ...
    with bot_col2:
        st.markdown(
            ...
            <div class="aira-card">
                <div class="aira-card-header">
                    <div class="aira-card-title">📖 Journals</div>
                    <span class="aira-card-link">View All</span>
                </div>
                <div class="activity-item">
                    <div>
    ...
    with bot_col3:
        st.markdown(
            ...
            <div class="aira-card">
                <div class="aira-card-header">
                    <div class="aira-card-title">🔖 Bookmarks</div>
                    <span class="aira-card-link">View All</span>
                </div>
                <div class="activity-item">
                    <div class="activity-icon" style="background: #f5f3ff; color: #7c3aed;">🔗</div>
