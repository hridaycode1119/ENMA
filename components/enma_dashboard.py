...
def render_enma_dashboard(orchestrator: AgentOrchestrator, on_navigate_view) -> None:
            ...
            <div style="position: relative; z-index: 10;">
                ...
                <div style="margin-bottom: 6px;">
                    <div style="display: flex; align-items: center; gap: 10px;">
                        ...
                        <h2 style="font-size: 24px; font-weight: 700; letter-spacing: -0.01em; color: #ffffff; margin: 0;">Hi Vaishnavi — Good to see you!</h2>
                    </div>
    ...
    with st.container():
        ...
        with q1:
            if st.button("✉️ Draft Email", use_container_width=True, key="btn_quick_draft_mail"):
    ...
    with main_col:
                    ...
                    <div>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px; text-align: center; margin-bottom: 12px;">
                            <div style="background: rgba(26, 11, 18, 0.8); border: 1px solid rgba(43, 16, 31, 0.6); border-radius: 12px; padding: 8px 4px;">
                                <span style="color: #fb719e; font-size: 12px; margin-bottom: 2px; display: block;">✉️</span>
                ...
                <div style="background: rgba(35, 12, 24, 0.7); border: 1px solid rgba(43, 16, 31, 0.8); border-radius: 16px; padding: 16px; height: 100%; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 8px;">
                        ...
                        <div style="padding: 8px; border-radius: 12px; background: rgba(26, 11, 18, 0.8); border: 1px solid rgba(43, 16, 31, 0.6); cursor: pointer;">
                            <div style="display: flex; align-items: center; justify-content: space-between; gap: 8px;">
                                <div style="display: flex; align-items: center; gap: 8px;">
                                    <span style="font-size: 12px; color: #fb719e;">✉️</span>
        ...
        st.markdown(
            ...
            <div style="background: rgba(35, 12, 24, 0.6); border: 1px solid rgba(43, 16, 31, 0.8); border-radius: 16px; padding: 20px; box-shadow: 0 8px 24px rgba(20, 6, 13, 0.3); margin-bottom: 20px;">
                <div style="display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid rgba(43, 16, 31, 0.6); padding-bottom: 12px; margin-bottom: 16px;">
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <span style="color: #fb719e; font-size: 16px;">✉️</span>
        ...
        with t_col1:
            ...
            if st.button("🚀 Client Proposal", help="Business", use_container_width=True, key="btn_tmpl_prop_ex"):
                _set_template_and_navigate("Client Proposal")
        with t_col2:
            if st.button("📄 Leave Application", help="HR & leave", use_container_width=True, key="btn_tmpl_leave_ex"):
                _set_template_and_navigate("Leave Application")
            if st.button("⚠️ Urgent Alert", help="Important / Escalation", use_container_width=True, key="btn_tmpl_urg_ex"):
        ...
        with t_col4:
            if st.button("🎓 BTech Major Project", help="Academic / Project", use_container_width=True, key="btn_tmpl_btech_ex"):
                _set_template_and_navigate("BTech Major Project")
            if st.button("👥 Weekly Sync Agenda", help="Team sync", use_container_width=True, key="btn_tmpl_synca_ex"):
                _set_template_and_navigate("Weekly Sync Agenda")

        st.write("")
        render_email_composer(key_prefix="dash_exact_")
    ...
    with side_col:
        ...
        if st.button("🎙️ Speak Command Now", key="btn_dash_mic_trigger_exact", type="primary", use_container_width=True):
