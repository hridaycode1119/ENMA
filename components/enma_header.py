...
def render_enma_header(on_new_task_click=None) -> None:
    """Renders the clean, aesthetic ENMA top header bar."""
    ...
    with col_greeting:
        st.markdown(
            ...
            <div style="padding: 0.2rem 0;">
                <h1 class="enma-greeting-title lucora-greeting-title">Good morning, Vaishnavi</h1>
                <div class="enma-tagline-badge lucora-tagline-badge">
                    <span>✦</span> <strong>ENMA</strong> &nbsp;•&nbsp; <span>Intelligence That Gets Work Done</span>
                </div>
            </div>
            """,
        ...
        with btn_col:
            if st.button("＋ New Task", key="header_new_task_btn", type="primary", use_container_width=True):
                if on_new_task_click:
                    ...
                    st.session_state["enma_active_view"] = "dashboard"
